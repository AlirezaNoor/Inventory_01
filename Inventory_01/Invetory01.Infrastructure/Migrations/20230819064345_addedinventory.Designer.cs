...
namespace Invetory01.Infrastructure.Migrations
{
    ...
    [Migration("20230819064345_addedinventory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Domin.InventoryVoucher.InventoryVoucheritemShopping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("InventoryVoucherShoppingId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("InventoryVoucherShoppingId");

                    b.ToTable("InventoryVoucheritemShopping");
                });
            ...
            modelBuilder.Entity("Inventory.Domin.InventoryVoucher.InventoryVoucheritemShopping", b =>
                {
                    b.HasOne("Inventory.Domin.InventoryVoucher.InventoryVoucher_Shopping", "InventoryVoucherShopping")
                        ...
                        .HasForeignKey("InventoryVoucherShoppingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
